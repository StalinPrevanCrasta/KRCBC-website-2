...
export interface ApiAboutKrcbcAboutKrcbc extends Struct.SingleTypeSchema {
  collectionName: 'about_krcbcs';
  info: {
    displayName: 'About KRCBC';
    pluralName: 'about-krcbcs';
    singularName: 'about-krcbc';
  };
  options: {
...
export interface ApiBankAccountBankAccount extends Struct.SingleTypeSchema {
...
export interface ApiCarousalCarousal extends Struct.CollectionTypeSchema {
  collectionName: 'carousals';
  info: {
    displayName: 'Carousal';
    pluralName: 'carousals';
    singularName: 'carousal';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiCommissionCommission extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ChairmanImage: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    ...
    publishedAt: Schema.Attribute.DateTime;
    SecretaryImage: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
...
export interface ApiDeskDesk extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Link: Schema.Attribute.Blocks;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::desk.desk'> &
      Schema.Attribute.Private;
    objectives: Schema.Attribute.Blocks;
    publishedAt: Schema.Attribute.DateTime;
    SecretaryImage: Schema.Attribute.Media<
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    RSVPLink: Schema.Attribute.Blocks;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiFeaturedvideoFeaturedvideo
  extends Struct.CollectionTypeSchema {
  collectionName: 'featuredvideos';
  info: {
    displayName: 'Featuredvideo';
    pluralName: 'featuredvideos';
    singularName: 'featuredvideo';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::featuredvideo.featuredvideo'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    thumbnail_url: Schema.Attribute.Blocks;
    title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiLogoLogo extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    krcbc_logo: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiNewsArticleNewsArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    Name: Schema.Attribute.String;
    NewsType: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
